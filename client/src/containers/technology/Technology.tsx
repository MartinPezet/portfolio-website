...
const Technology = () => {
  return (
    <section className="max-w-6xl mx-auto mb-36 px-4 xs:px-8 sm:px-12 md:px-16">
        <h2 className="text-3xl md:text-5xl uppercase mb-2">Technologies</h2>
        <p className="max-md:xs:px-4 mb-8 text-slate-400">I'm an adaptive person and willing to pick up and learn any technologies but these are my favourites at present.</p>
